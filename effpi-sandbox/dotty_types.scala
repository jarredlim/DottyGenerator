...
package implementation {
  ...
  import effpi.process.dsl._
   ...
   def buyerA2(
      ...
      c_BuyerA_Seller_3: OutChannel[buy],
      c_BuyerA_Seller_4: OutChannel[cancel]
   ):BuyerA2[x2.type,c_BuyerA_Seller_3.type,c_BuyerA_Seller_4.type] =
      x2 match {
         case x2 : accept => {
   ...
   def seller(
      ...
      c_BuyerB_Seller_1: OutChannel[quote],
      c_BuyerA_Seller_3: InChannel[cancel|buy]
   ):Seller[c_BuyerA_Seller_1.type,c_BuyerA_Seller_2.type,c_BuyerB_Seller_1.type,c_BuyerA_Seller_3.type] ={
