...
C_P_C_1 <: OutChannel[Test1|Test2|Test3]] =
 ((Out[C_P_S_1,Test1] >>: ((Out[C_P_C_1,Test1] >>: PNil)|(Out[C_P_C_1,Test2] >>: PNil)))| (Out[C_P_S_1,Test2] >>: ((Out[C_P_C_1,Test2] >>: PNil)|(Out[C_P_C_1,Test3] >>: PNil))))
