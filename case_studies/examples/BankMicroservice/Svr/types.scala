...
case Deposit1 => Out[C_Svr_SvrAct_5,Deposit2] >>: Out[C_Svr_SvrVer_3,Continue] >>: In[C_Svr_SvrAct_7, Success|Fail, (X_5:Success|Fail) => Svr_5[X_5.type,C_Svr_Client_3,C_Svr_SvrVer_3,C_Svr_Client_4,C_Svr_SvrVer_4,C_Svr_SvrAct_8,C_Svr_SvrAct_9]] 
